...
static const _DrlStep_Request_type_support_symbol_names_t _DrlStep_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_msgs, srv, DrlStep_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, DrlStep_Request)),
  }
};
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_cpp::DrlStep_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_msgs, srv, DrlStep_Request)() {
  return get_message_type_support_handle<turtlebot3_msgs::srv::DrlStep_Request>();
}
...
static const _DrlStep_Response_type_support_symbol_names_t _DrlStep_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_msgs, srv, DrlStep_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, DrlStep_Response)),
  }
};
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_cpp::DrlStep_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_msgs, srv, DrlStep_Response)() {
  return get_message_type_support_handle<turtlebot3_msgs::srv::DrlStep_Response>();
}
...
static const _DrlStep_type_support_symbol_names_t _DrlStep_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_msgs, srv, DrlStep)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, DrlStep)),
  }
};
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_cpp::DrlStep_service_type_support_handle;
}
